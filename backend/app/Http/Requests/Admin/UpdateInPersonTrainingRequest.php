...
// app/Http/Requests/Admin/UpdateInPersonTrainingRequest.php
...
class UpdateInPersonTrainingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'title' => [
                ...
                'string',
                'max:255',
                Rule::unique('in_person_trainings', 'title')->ignore($trainingId)
            ],
            'slug' => [
                'nullable',
                'string',
                'max:255',
                Rule::unique('in_person_trainings', 'slug')->ignore($trainingId)
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'city_name.required' => 'Le lieu de formation est requis.',
