    ...
    <div className="space-y-20">
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 flex flex-col min-h-screen">
          ...
          <div className="relative z-10">
            ...
            <div className="absolute top-[-20%] left-[5%] w-full h-full flex justify-center items-start">
              <img
                src="Public/asset/LOGO EMPOWER FORMATION/Symbol EF.jpg"
          ...
          {/* Button Section */}
          <div className="flex items-center justify-center space-x-4 sm:space-x-8 pt-12 z-10 relative flex-wrap">
            <ArrowRight className="h-6 w-4 sm:h-6 sm:w-6 text-purple-600" />
            ...
            >
              Commence ta formation dès aujourd'hui
            </button>
            
            <ArrowRight className="h-6 w-4 sm:h-6 sm:w-6 text-purple-600 transform rotate-180" />
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 bg-gray-50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center">
                <span className="font-bold text-purple-600">350 F CFA</span>
                <button 
                  onClick={() => navigate('/login')}
                  className="bg-purple-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-purple-700 transition-colors transform hover:scale-105"
                >
                  S'inscrire
                </button>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center">
                <span className="font-bold text-purple-600">450 F CFA</span>
                <button 
                  onClick={() => navigate('/login')}
                  className="bg-purple-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-purple-700 transition-colors transform hover:scale-105"
                >
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center">
                <span className="font-bold text-purple-600">280 F CFA</span>
                <button 
                  onClick={() => navigate('/login')}
                  className="bg-purple-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-purple-700 transition-colors transform hover:scale-105"
                >
        ...
        <div className="text-center mt-10">
          <button 
            onClick={() => navigate('/catalog')}
            className="border-2 border-purple-600 text-purple-600 px-6 py-3 rounded-lg font-semibold hover:bg-purple-50 transition-all duration-300 flex items-center space-x-2 mx-auto hover:translate-x-2"
          >
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <button 
              onClick={() => navigate('/login')}
              className="mt-8 bg-gradient-to-r from-purple-600 to-pink-600 px-8 py-4 rounded-lg text-white text-lg font-semibold hover:opacity-90 transition-all duration-300 hover:shadow-lg transform hover:translate-y-1"
            >
