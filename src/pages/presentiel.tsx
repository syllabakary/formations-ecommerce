...
//Imports des nouveaux composants (commentés car non définis dans le fichier)
...
// Hook toast local - version de fallback
const useLocalToast = () => {
...
// Composant LazyImage simplifié
const LazyImage: React.FC<{ src: string; alt: string; className: string }> = ({ src, alt, className }) => {
  return <img src={src} alt={alt} className={className} loading="lazy" />;
};

// Composant ShareButton simplifié
  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 relative">
      ...
      <div className="p-6">
        ...
        <h3 className="text-xl font-bold text-gray-900 mb-2 line-clamp-2 cursor-pointer hover:text-blue-600" 
...
const InPersonTrainingCatalog: React.FC = () => {
  ...
  // Charger les données de filtrage
  useEffect(() => {
  ...
  }, [debouncedSearchTerm, selectedCity, selectedCategory, activeTab, currentPage, sortBy, sortOrder]);
  ...
  const handleRegistrationSuccess = () => {
    ...
    loadTrainings(); // Recharger pour mettre à jour les places disponibles
  };
  ...
  const handleToggleComparison = (training: Training) => {
    setComparison(prev => {
      ...
      if (exists) {
        ...
        console.log('Vous pouvez comparer maximum 3 formations');
        return prev;
      }
    });
  };
          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 bg-white text-blue-600 rounded font-medium hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Comparer
              </button>
              <button
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8">
              Apprentissage immersif avec nos experts dans des lieux inspirants à travers l'Afrique
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div>
              ...
              >
                ...
                <option value="start_date-desc">Date (plus lointaine)</option>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 flex items-center gap-2">
            <AlertCircle className="h-5 w-5 text-red-500" />
            <span className="text-red-700">Erreur lors du chargement : {error}</span>
          </div>
        )}
      ...
      <div className="bg-gradient-to-r from-blue-700 to-blue-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Vous souhaitez organiser une formation sur mesure pour votre équipe ?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Nous concevons des programmes adaptés à vos besoins spécifiques et pouvons intervenir dans vos locaux.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="px-8 py-4 bg-white text-blue-800 rounded-lg font-bold hover:bg-gray-100 transition-all">
              Demander un devis
            </button>
            <button className="px-8 py-4 border-2 border-white text-white rounded-lg font-bold hover:bg-white/10 transition-all">
              Contactez-nous
            </button>
          </div>
        </div>
